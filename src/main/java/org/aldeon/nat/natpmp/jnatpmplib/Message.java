...
public abstract class Message {
     ...
     * response parsing ran into some trouble.
     */
    public Long getSecondsSinceEpoch() throws NatPmpException {
        // Return the address.
    ...
    private void internalNotifyListener() throws NatPmpException {
        ...
        secondsSinceEpoch = longFromByteArray(response, 4);
        switch (intFromByteArray(response, 2)) {
            case 0:
            ...
            default:
                throw new NatPmpException("Unsupported Result Code: " + intFromByteArray(response, 2));
        }
