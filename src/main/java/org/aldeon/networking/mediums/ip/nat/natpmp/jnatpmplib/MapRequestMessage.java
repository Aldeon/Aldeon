 ...
 * {@link #MapRequestMessage(boolean, int, int, long, MessageResponseInterface) }
...
public class MapRequestMessage extends Message {
    ...
    public MapRequestMessage(boolean isTCP, int internalPort, int requestedExternalPort,
            long requestedPortMappingLifetime, MessageResponseInterface listener) {
    ...
    byte[] getRequestPayload() {
        ...
        intToByteArray(getInternalPort(),request, 4); // Internal Port
        intToByteArray(getRequestedExternalPort(),request, 6); // Requested External Port
        longToByteArray(getRequestedPortMappingLifetime(),request, 8); // Request Port Mapping Lifetime in Seconds
    ...
    void parseResponse(byte[] response) throws NatPmpException {
        ...
        externalPort = intFromByteArray(response, 10);
        portMappingLifetime = longFromByteArray(response, 12);
    }
