...
import org.aldeon.communication.http_provider.jetty_receiver.JettyReceiver;
...
public class CommunicationModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        bind(new TypeLiteral<Receiver<String>>(){})
                .to(JettyReceiver.class);
        ...
        bind(ICommunicationProvider.class).to(
                new TypeLiteral<CommunicationProvider<String>>(){});
